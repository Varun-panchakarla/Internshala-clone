...
import { FiBriefcase, FiUser, FiHeart, FiFileText, FiLogOut, FiMenu, FiX, FiGrid } from 'react-icons/fi';
...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white border-b border-slate-100 sticky top-0 z-40">
        ...
        <div className="flex justify-between h-16">
              ...
              <div className="relative">
                ...
                {dropdownOpen && (
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 rounded-2xl bg-white border border-slate-100 shadow-xl py-2 z-20 animate-fade-in">
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm text-rose-600 hover:bg-rose-50 font-medium border-t border-slate-100"
                      >
          ...
          <div className="flex items-center md:hidden">
            <button
              ...
              className="p-2 rounded-lg text-slate-500 hover:bg-slate-50 transition-colors focus:outline-none"
            >
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-slate-100 bg-white px-4 py-4 space-y-3 animate-fade-in shadow-lg">
          ...
          {isAuthenticated ? (
            <div className="pt-4 border-t border-slate-100 space-y-3">
              <Link
                to="/profile"
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center gap-2 px-3 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-50 rounded-xl"
              >
                <FiUser className="w-4 h-4 text-slate-400" />
              ...
              <button
                onClick={handleLogout}
                className="w-full flex items-center gap-2 px-3 py-2 text-sm font-semibold text-rose-600 hover:bg-rose-50 rounded-xl"
              >
                <FiLogOut className="w-4 h-4 text-rose-400" />
                <span>Logout</span>
              </button>
