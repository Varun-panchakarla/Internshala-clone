    ...
    <nav className="w-full bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 sticky top-0 z-40 transition-colors duration-250">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          {/* Logo */}
          <div className="flex items-center pl-1 sm:pl-2 lg:pl-3">
                  ...
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl py-2 z-20 animate-fade-in">
                      ...
                      <Link
                        to="/manage-account"
                        onClick={() => setDropdownOpen(false)}
                        className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 font-medium border-t border-slate-100 dark:border-slate-800"
                      >
                        <FiSettings className="w-4 h-4 text-slate-400 dark:text-slate-500" />
                        Manage Account
                      </Link>
