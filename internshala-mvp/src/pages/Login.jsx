            ...
            {googleUserError && (
              <div className="p-4 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/40 rounded-xl flex flex-col gap-3 animate-fade-in">
                ...
                <div className="relative w-full h-[44px] select-none">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center rounded-xl border border-transparent bg-brand-500 hover:bg-brand-600 text-white text-sm font-bold shadow-sm pointer-events-none transition-colors">
                    <div className="absolute left-3.5 flex items-center bg-white p-0.5 rounded-full">
