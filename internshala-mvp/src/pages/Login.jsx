  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-slate-50 font-sans">
        ...
        <div className="max-w-md w-full flex flex-col gap-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="text-right">
              <span className="text-xs font-semibold text-brand-600 hover:text-brand-700 hover:underline cursor-pointer">
                Forgot Password?
              </span>
            </div>
          ...
          {/* Quick seeded login notice for convenience */}
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 text-xs text-slate-500 flex flex-col gap-1 leading-relaxed">
            <span className="font-bold text-slate-700">Quick Test Credentials:</span>
            <span>• Email: <code className="bg-slate-200/50 px-1 py-0.5 rounded font-mono">jane@example.com</code> / Password: <code className="bg-slate-200/50 px-1 py-0.5 rounded font-mono">password123</code> (Jane's Profile: 100% complete)</span>
            <span>• Email: <code className="bg-slate-200/50 px-1 py-0.5 rounded font-mono">john@example.com</code> / Password: <code className="bg-slate-200/50 px-1 py-0.5 rounded font-mono">password123</code> (John's Profile: Needs setup)</span>
          </div>
      ...
      <div className="hidden lg:col-span-7 bg-gradient-to-br from-brand-600 via-indigo-700 to-slate-900 lg:flex flex-col justify-between p-16 text-white relative overflow-hidden">
        ...
        {/* Floating cards to mimic dashboard items */}
        <div className="absolute top-[25%] right-[10%] w-72 p-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl rotate-3 animate-pulse-slow">
        ...
        <div className="flex items-center gap-2.5">
          <span className="text-xs font-black tracking-widest uppercase bg-white/20 px-2.5 py-1 rounded">
            PORTAL MVP 2.0
          </span>
        </div>
